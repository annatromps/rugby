...
export default async function PlayerProfilePage({
  ...
  const [player, account, admin] = await Promise.all([
    getPublicPlayer(id),
    getPortalAccount(),
    getAdminSession(),
  ]);
  ...
  // A signed-in visitor account OR a staff member both count as "signed
  // in" for revealing this player's real name/photo -- see the matching
  // comment on players/page.tsx.
