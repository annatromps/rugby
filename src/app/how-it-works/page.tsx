...
const STEPS = [
  {
    ...
    body: "Players list position, level, and experience. Coaches list their specialisation and coaching level. Clubs list their league, level, and open positions. It takes a few minutes, and you can update it any time.",
  },
  {
    ...
    <div className="flex min-h-full flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
          ...
          <div className="mt-10 flex flex-col items-center gap-4 rounded-xl border border-slate-200 bg-slate-50 p-8 text-center">
